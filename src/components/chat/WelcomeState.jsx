...
export default function WelcomeState() {
  return (
    <section
      className="relative flex h-full w-full items-start justify-center overflow-hidden px-4 pt-16 sm:items-center sm:px-8 sm:pt-0"
      aria-labelledby="welcome-heading"
    >
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute left-1/2 top-[34%] h-[360px] w-[360px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-500/10 blur-3xl sm:top-[42%] sm:h-[520px] sm:w-[520px]" />
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center text-center sm:-translate-y-16 md:-translate-y-14">
        <div className="h-40 w-48 overflow-hidden sm:h-56 sm:w-64 md:h-64 md:w-72 lg:h-72 lg:w-80 xl:h-80 xl:w-96">
          <img
            src={Jarvice}
            alt="Jarvice"
            className="h-full w-full scale-125 object-contain object-center"
        ...
        <h1
          id="welcome-heading"
          className="-mt-5 mx-auto max-w-[320px] text-[36px] font-semibold leading-[1.08] tracking-tight text-white sm:max-w-2xl sm:text-5xl md:-mt-8 md:text-6xl lg:-mt-10 lg:text-[56px]"
        >
          What can I help you build today?
        </h1>
      </div>
